...
public interface Java8Listener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link Java8Parser#entryPoint}.
	 * @param ctx the parse tree
	 */
	void enterEntryPoint(Java8Parser.EntryPointContext ctx);
	/**
	 * Exit a parse tree produced by {@link Java8Parser#entryPoint}.
	 * @param ctx the parse tree
	 */
	void exitEntryPoint(Java8Parser.EntryPointContext ctx);
	/**
